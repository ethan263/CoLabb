...
export default function Hero({ introFinished }: HeroProps) {
  ...
  return (
    <section
      id="hero"
      ref={containerRef}
      className="relative min-h-screen min-h-dvh w-full pt-28 sm:pt-32 md:pt-36 pb-16 px-6 md:px-12 flex flex-col justify-between bg-colab-bg text-colab-dark overflow-hidden select-none"
    >
